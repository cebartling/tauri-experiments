...
export default function StockChart() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <h1 className="mb-6 text-3xl font-bold text-gray-900">Stock Price Charts</h1>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        ...
        {!isLoading && !error && data && data.length > 0 && (
          <div>
            ...
            <StockLineChart data={data} symbol={activeSymbol || ''} />
          </div>
        )}
      ...
      <div className="mt-8 rounded-lg border border-blue-200 bg-blue-50 p-4">
        <h3 className="mb-2 font-semibold text-blue-900">About the Chart</h3>
        <ul className="list-disc space-y-1 pl-5 text-sm text-blue-800">
          <li>Hover over the chart to see detailed price information</li>
          <li>Select different intervals to view various time frames</li>
          <li>Data is automatically refreshed every 60 seconds</li>
          <li>Chart shows intraday trading data with open, high, low, close prices</li>
        </ul>
      </div>
    </div>
  );
